...
import vivadoHLS._
import memControl._
import hls_rocc0_vadd_vadd._

class HLSrocc0_vadd_vaddControl(opcodes: OpcodeSet)(implicit p: Parameters) extends LazyRoCC(opcodes) {
  override lazy val module = new HLSrocc0_vadd_vaddControlModule(this)
}

class HLSrocc0_vadd_vaddControlModule(outer: HLSrocc0_vadd_vaddControl)(implicit p: Parameters) extends LazyRoCCModuleImp(outer) 
...
//===== Begin Accelerator =====
val accel = Module(new HLSrocc0_vadd_vaddBlackbox())
